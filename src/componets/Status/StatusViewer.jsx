...
const StatusViewer = () => {
    ...
    const[curentStoryIndex, setCurentStoryIndex] = React.useState(0);
    ...
    <div>
        <div className='relative flex justify-center items-center h-[100vh] bg-slate-900'>
            ...
            <div className='absolute top-0 flex w-full'>
                {stories.map((story, index) => <ProgressBar key={index} duration={2000} index={index} activeIndex={activeIndex} />)}
            </div>
        </div>
        <div>
